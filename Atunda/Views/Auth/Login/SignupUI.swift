...
class SignupUI{
    ...
    func setup() {
        ...
        containerView.addToSides(view: signup, y: scrollView.frame.size.height - 60.0, height: 50, width: containerView.frame.size.width - 48.0)
        ...
        signUpLabel.textColor = Constants.orange
        ...
        baseView.addToSides(view: haveAccountStack, y: scrollView.frame.size.height + scrollView.frame.origin.y, height: 30, width: 250)
